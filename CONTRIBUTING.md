Contributing to Universe Core
==============================

The Universe Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Universe Core project, and is not to be
confused with overall Universe Network Protocol consensus changes.

Whether a pull request is merged into Universe Core rests with the project merge
...
Patches that change Universe consensus rules are considerably more involved than
...
Where a patch set proposes to change the universe consensus, it must have been
...
The project leader is the release manager for each Universe Core release.
